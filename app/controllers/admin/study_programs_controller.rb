module Admin
  class StudyProgramsController < Admin::AdminController
    ...
    def create(study_program)
      ...
      if @study_program.save
        redirect_to admin_study_programs_path, notice: 'Study program was successfully created.'
      else
        render :new
      end
    end
    ...
    def update(study_program)
      if @study_program.update(study_program)
        redirect_to admin_study_programs_path, notice: 'Study program was successfully updated.'
      else
        render :edit
      end
    end
    ...
    def destroy
      ...
      redirect_to admin_study_programs_url, notice: 'Study program was successfully destroyed.'
    end
